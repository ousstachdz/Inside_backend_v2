    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to=user.models.UserApp.user_directory_path, verbose_name='photo')),
                ('photo_cover', models.ImageField(blank=True, null=True, upload_to=user.models.UserApp.user_directory_path_for_cover, verbose_name='photo_cover')),
            ...
            managers=[
                ('objects', user.models.UserAppManager()),
            ],
        ),
    ]
